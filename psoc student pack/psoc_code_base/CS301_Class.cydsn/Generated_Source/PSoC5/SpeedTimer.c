...
{
   #if(SpeedTimer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(SpeedTimer_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG16(SpeedTimer_PERIOD_LSB_PTR));
   #endif /* (SpeedTimer_UsingFixedFunction) */
}
...
void SpeedTimer_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(SpeedTimer_PERIOD_LSB_PTR, period);
...
{
   #if(SpeedTimer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(SpeedTimer_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG16(SpeedTimer_CAPTURE_LSB_PTR));
   #endif /* (SpeedTimer_UsingFixedFunction) */
}
...
void SpeedTimer_WriteCounter(uint16 counter) 
{
    ...
    #else
        CY_SET_REG16(SpeedTimer_COUNTER_LSB_PTR, counter);
