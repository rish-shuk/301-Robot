...
#if !defined(CY_TIMER_SpeedTimer_H)
#define CY_TIMER_SpeedTimer_H
...
#define SpeedTimer_Resolution                 16u
#define SpeedTimer_UsingFixedFunction         1u
...
uint16  SpeedTimer_ReadPeriod(void) ;
void    SpeedTimer_WritePeriod(uint16 period) ;
uint16  SpeedTimer_ReadCounter(void) ;
void    SpeedTimer_WriteCounter(uint16 counter) ;
uint16  SpeedTimer_ReadCapture(void) ;
...
#define SpeedTimer_INIT_PERIOD             999u
#define SpeedTimer_INIT_CAPTURE_MODE       ((uint8)((uint8)1u << SpeedTimer_CTRL_CAP_MODE_SHIFT))
...
***************************************/
    ...
    ***************************************/
    ...
    #define SpeedTimer_CONTROL             (* (reg8 *) SpeedTimer_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define SpeedTimer_CAPTURE_LSB         (* (reg8 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define SpeedTimer_CAPTURE_LSB_PTR       ((reg8 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define SpeedTimer_PERIOD_LSB          (* (reg8 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define SpeedTimer_PERIOD_LSB_PTR        ((reg8 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define SpeedTimer_COUNTER_LSB         (* (reg8 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
        #define SpeedTimer_COUNTER_LSB_PTR       ((reg8 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
    #elif(SpeedTimer_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define SpeedTimer_CAPTURE_LSB         (* (reg16 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__F0_REG )
            #define SpeedTimer_CAPTURE_LSB_PTR       ((reg16 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__F0_REG )
            #define SpeedTimer_PERIOD_LSB          (* (reg16 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__D0_REG )
            #define SpeedTimer_PERIOD_LSB_PTR        ((reg16 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__D0_REG )
            #define SpeedTimer_COUNTER_LSB         (* (reg16 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
            #define SpeedTimer_COUNTER_LSB_PTR       ((reg16 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define SpeedTimer_CAPTURE_LSB         (* (reg16 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__16BIT_F0_REG )
            #define SpeedTimer_CAPTURE_LSB_PTR       ((reg16 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__16BIT_F0_REG )
            #define SpeedTimer_PERIOD_LSB          (* (reg16 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__16BIT_D0_REG )
            #define SpeedTimer_PERIOD_LSB_PTR        ((reg16 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__16BIT_D0_REG )
            #define SpeedTimer_COUNTER_LSB         (* (reg16 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__16BIT_A0_REG )
            #define SpeedTimer_COUNTER_LSB_PTR       ((reg16 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(SpeedTimer_Resolution <= 24u)/* 24-bit Timer */
        #define SpeedTimer_CAPTURE_LSB         (* (reg32 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define SpeedTimer_CAPTURE_LSB_PTR       ((reg32 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define SpeedTimer_PERIOD_LSB          (* (reg32 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define SpeedTimer_PERIOD_LSB_PTR        ((reg32 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define SpeedTimer_COUNTER_LSB         (* (reg32 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
        #define SpeedTimer_COUNTER_LSB_PTR       ((reg32 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define SpeedTimer_CAPTURE_LSB         (* (reg32 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__32BIT_F0_REG )
            #define SpeedTimer_CAPTURE_LSB_PTR       ((reg32 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__32BIT_F0_REG )
            #define SpeedTimer_PERIOD_LSB          (* (reg32 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__32BIT_D0_REG )
            #define SpeedTimer_PERIOD_LSB_PTR        ((reg32 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__32BIT_D0_REG )
            #define SpeedTimer_COUNTER_LSB         (* (reg32 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__32BIT_A0_REG )
            #define SpeedTimer_COUNTER_LSB_PTR       ((reg32 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define SpeedTimer_COUNTER_LSB_PTR_8BIT       ((reg8 *) SpeedTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
