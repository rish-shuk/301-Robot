...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b6d05aba-3cf5-497d-b94c-049df64d7feb"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2d21c774-0937-4d04-9b6c-9708b2ae2862"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f970c594-8c66-46cd-a39f-d15ee5661d86"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("64aa4f0a-5bf4-4f7e-b4f4-ae6f5cb4ba40"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam SpeedTimer.Resolution = 16;
    defparam SpeedTimer.SiliconRevision = "0";
	...
	cy_clock_v1_0
		#(.id("d4a1abb2-37e0-4ed9-b858-c75d57d77d5f"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("538b0a8a-8b84-4a2c-ab91-c1c9dc93faf8"),
    ...
    Timer_v2_80_9 Timer_LED (
        .reset(Net_5391),
        .interrupt(Net_5372),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_5393),
        .tc(Net_5396),
        .clock(Net_5389));
    ...
    defparam Timer_LED.Resolution = 16;
    ...
    EdgeDetect_v1_0 EdgeDetect_4 (
        ...
        .det(Net_5438),
        .clock(Net_4660));
    defparam EdgeDetect_4.EdgeType = 0;
    ...
    EdgeDetect_v1_0 EdgeDetect_6 (
        ...
        .det(Net_5444),
        .clock(Net_4660));
    defparam EdgeDetect_6.EdgeType = 0;
