...
*
* \funcusage
*  \snippet Sout_SUT.c usage_Sout_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Sout_SUT.c usage_Sout_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Sout_SUT.c usage_Sout_Read  
*******************************************************************************/
...
* preferred Sout_Read() API because the 
* Sout_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Sout_SUT.c usage_Sout_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Sout_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Sout_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Sout_0_INTR       (First pin in the list)
    *  - Sout_1_INTR       (Second pin in the list)
    *  - ...
    *  - Sout_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Sout_SUT.c usage_Sout_SetInterruptMode
    *******************************************************************************/
    void Sout_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Sout_0_INTR) != 0u) 
		{ 
			 Sout_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Sout_SUT.c usage_Sout_ClearInterrupt
    *******************************************************************************/
